            ...
            <table class="table text-start">
                <thead>
                    <tr>
                        ...
                        <th scope="col"><?php __('tpl_cart_delete') ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($_SESSION['cart'] as $id => $item) : ?>
                        <tr>
                            ...
                            <td><?= $item['qty'] ?></td>
                            <td><?= $item['price'] ?></td>
                            <td><a href="cart/delete?id=<?= $id ?>" class="del-item">Удалить</a></td>
                        </tr>
                    <?php endforeach; ?>
                    <tr>
...
<div class="modal-footer">
    <button type="button" class="btn btn-succes ripple" data-bs-dismiss="modal"><?php __('tpl_cart_btn_continue') ?></button>
    <?php if (!empty($_SESSION['cart'])) : ?>
        <button type="button" class="btn btn-primary"><?php __('tpl_cart_btn_order') ?></button>
        <button type="button" class="btn btn-primary"><?php __('tpl_cart_btn_clear') ?></button>
    <?php endif; ?>
</div>